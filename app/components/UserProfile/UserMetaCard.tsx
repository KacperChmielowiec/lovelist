...
import { getAvatarUrl, updateAvatar } from "./actions";
...
export default function UserMetaCard() {
  ...
  const { handleSubmit, control, formState: { errors } } = useForm<LogoForm>()

  useEffect(() => {
    getAvatarUrl().then(setUrl)
  }, [])

  const handleSave = async (data: LogoForm) => {
    await updateAvatar(data.logo)
    getAvatarUrl().then(setUrl)
    closeModal();
  };
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <img src={url ?? 'https://pmkkntabjsicomplrkor.supabase.co/storage/v1/object/public/users_avatar/default-avatar.png'} alt="user" />
            </div>
